...
\begin{table}[htbp]
    ...
    \begin{tabular}{ll ll}
    \toprule
    \textbf{Loss type}&\textbf{Parameter} & \textbf{Mean}&\textbf{Std}\\
    \midrule
    ...
    \midrule
    \multirow{4}{*}{[60\degree, 120\degree] \& [240\degree, 300\degree]}
...
\begin{figure}[ht]
    ...
    \vspace{-1cm}
    \caption{Comparison of original PET brain image (top) with PET image refined from the raw images reconstructed from predicted sinogram (bottom).
    }
